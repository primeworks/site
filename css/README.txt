...
To use these stylesheets, rename the files and kleen_house with the name of your theme.
...
kleen_house-alpha-default-narrow.css  
...
kleen_house-alpha-default-normal.css
...
kleen_house-alpha-default-wide.css
